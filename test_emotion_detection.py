...
class TestEmotionDetector(unittest.TestCase):
    ...
    def test_emotion_disgust(self):
        """ Test that disgust text returns disgust as the dominant emotion. """
        result=emotion_detector('I feel disgusted just hearing about this')
        self.assertEqual(result["dominant_emotion"], "disgust")

    def test_emotion_fear(self):
        """ Test that fearful text returns fear as the dominant emotion. """
        result=emotion_detector('I am really scared about this')
        self.assertEqual(result["dominant_emotion"], "fear")

    def test_emotion_joy(self):
        """ Test that joyful text returns joy as the dominant emotion. """
        result=emotion_detector('I am so happy about this')
        self.assertEqual(result["dominant_emotion"], "joy")

    def test_emotion_sadness(self):
        """ Test that sad text returns sadness as the dominant emotion. """
